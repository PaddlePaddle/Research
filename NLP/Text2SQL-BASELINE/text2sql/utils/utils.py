...
if __name__ == "__main__":
    ...
    table_json = {"rows": [[4.0, "污水运行工", "三峡碧江公司", "渝北", 2.0, "大专及以上", "给排水/环境工程/机电及相关专业", "sxswrlzyb@163.com"], [5.0, "污水运行工", "三峡垫江公司", "垫江", 1.0, "大专及以上", "给排水/环境工程/机电及相关专业", "sxswrlzyb@163.com"]], "name": "Table_a7b5108c3b0611e98ad7f40f24344a08", "title": "", "header": ["岗位序号", "招聘岗位", "用人单位", "工作地点", "招聘数量", "学历要求", "专业及资格要求", "简历投递邮箱"], "common": "", "id": "a7b510", "types": ["real", "text", "text", "text", "real", "text", "text", "text"]}
