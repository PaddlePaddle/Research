...
Filname: global_define.py
Authors: ZhangAo(@baidu.com)
Date: 2020-07-15 18:00:30
"""
...
def define_args_parser():
    ...
    parser.add_argument('-c', '--config',        default='conf/text2sql.jsonnet',
                                                 help='global config file path. it\'s priority is the lowest')

    general_args = parser.add_argument_group(title='general')
    general_args.add_argument('--mode',          type=str.lower, default='debug', required=False,
