...
class GptBpeTokenizer(object):
    ...
    def __init__(self, vocab_file=None, encoder_json_file=None, vocab_bpe_file=None, do_lower_case=True):
        if vocab_file is None:
            vocab_file = "./bpe/gpt2_bpe/vocab.txt"
        if encoder_json_file is None:
            encoder_json_file = "./bpe/gpt2_bpe/encoder.json"
        if vocab_bpe_file is None:
            vocab_bpe_file = "./bpe/gpt2_bpe/vocab.bpe"
...
def test_gpt_bpe_tokenizer():
    ...
    encoder_json_file = "./bpe/gpt2_bpe/encoder.json"
    vocab_bpe_file = "./bpe/gpt2_bpe/vocab.bpe"
    tokenizer = GptBpeTokenizer(vocab_file, encoder_json_file, vocab_bpe_file)

    # text = "Hello world!"
    text = "Want to contribute to PaddlePaddle/ERNIE?"
    print(text)
    text = convert_to_unicode(text)
