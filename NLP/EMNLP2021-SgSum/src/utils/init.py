...
def init_checkpoint(exe, init_checkpoint_path, main_program, use_fp16=False):
    ...
    print("Following params not existed in the params file:")
    print(non_existed_params)
...
def init_pretraining_params(exe,
    ...
    def existed_params(var):
        """detect existed param names"""
        if not isinstance(var, fluid.framework.Parameter):
            return False
        # print("check var_info: ", var.name, var.shape)
        if 'pos_embedding' in var.name:
            return False
