...
model_g.add_arg("ernie_config_path", str, "ernie/ernie_config.json", "Path to the json file for ernie model config.")
model_g.add_arg("init_checkpoint", str, None, "Init checkpoint to resume training from.")
model_g.add_arg("init_pretraining_params", str, "ernie/params",
...
train_g.add_arg("learning_rate", float, 1e-6, "Learning rate used to train with warmup.")
train_g.add_arg("lr_scheduler", str, "linear_warmup_decay",
                "scheduler of learning rate.", choices=['linear_warmup_decay', 'noam_decay'])
train_g.add_arg("weight_decay", float, 0.01, "Weight decay rate for L2 regularizer.")
train_g.add_arg("warmup_proportion", float, 0.0,
...
train_g.add_arg("test_save", str, "output/prediction.json", "test_save")
...
data_g.add_arg("tokenizer", str, "FullTokenizer",
               "ATTENTION: the INPUT must be splited by Word with blank \
                       while using SentencepieceTokenizer or WordsegTokenizer")
data_g.add_arg("train_set", str, "data/train.json", "Path to training data.")
data_g.add_arg("test_set", str, "data/test.json", "Path to test data.")
data_g.add_arg("dev_set", str, "data/dev.json", "Path to validation data.")
data_g.add_arg("vocab_path", str, "ernie/vocab.txt", "Vocabulary path.")
data_g.add_arg("max_seq_len", int, 256, "Number of words of the longest seqence.")
...
data_g.add_arg("label_map_config", str, "data/label_map_config.json", "label_map_path.")
...
multi_task_g = ArgumentGroup(parser, "run_type", "multi-task options.")
multi_task_g.add_arg("max_train_steps", int, None, "Max train steps. If not None, 'epoch' will be ignored")
multi_task_g.add_arg("mlm_filelist", str, None, "masked language model file list")
multi_task_g.add_arg("mlm_ratio", float, 2.0, "mix ratio for MLM task")
