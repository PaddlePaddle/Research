...
def optimization(loss,
    ...
    optimizer = paddle.fluid.optimizer.Adam(learning_rate=scheduled_lr,
                                            beta1=beta1,
                                            beta2=beta2,
                                            epsilon=epsilon,
    ...
    _, param_grads = optimizer.minimize(loss, paddle.fluid.default_startup_program())
    ...
    #                 [param, grad]), paddle.fluid.framework.name_scope("weight_decay"):
    #             updated_param = param - param_list[
    #                 param.name] * weight_decay * scheduled_lr.get_lr()
    #             paddle.fluid.layers.assign(output=param, input=updated_param)
