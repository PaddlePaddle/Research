...
"""
File: run_classifier_grounded.py
Author: liwei(liwei85@baidu.com)
Date: 2021-09-15 14:22
Desc: Finetuning on classification tasks.
"""
...
from reader.classification_grounded_reader import ClassifyReader
from model.unimo_grounded import VlConfig
from model.roberta_tokenization import GptBpeTokenizer
from finetune.classifier_grounded import create_model, evaluate, predict
from utils.optimization import optimization
from utils.utils import visualdl_log, get_time
from utils.args import print_arguments
from utils.init import init_pretraining_params, init_checkpoint
from args.classification_grounded_args import parser
...
def main(args):
    ...
    if not (args.do_train or args.do_val or args.do_val_hard or
            args.do_test or args.do_test_hard or args.do_diagnostic):
        raise ValueError(
            "For args `do_train`, `do_val`, `do_val_hard`, `do_test`, `do_test_hard` and `do_diagnostic`, at "
    ...
    if args.do_val or args.do_val_hard or args.do_test or args.do_test_hard or \
            args.do_pred or args.do_pred_hard or args.do_diagnostic:
    ...
    if args.do_train:
        ...
        if args.init_checkpoint:
            ...
            init_pretraining_params(
                ...
                main_program=train_program)
    elif args.do_val or args.do_val_hard or args.do_test or args.do_test_hard or \
            args.do_pred or args.do_pred_hard or args.do_diagnostic:
    ...
    test_exe = exe
    if args.do_val or args.do_val_hard or args.do_test or args.do_test_hard or args.do_pred \
            or args.do_pred_hard or args.do_diagnostic:
            ...
            try:
                ...
                if steps % skip_steps == 0:
                    ...
                    print("%s - epoch: %d, progress: %d/%d, step: %d, ave loss: %f, speed: %f steps/s" % \
                          (get_time(), current_epoch, current_example, num_train_examples, steps, outputs["loss"],
