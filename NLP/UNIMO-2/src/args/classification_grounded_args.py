...
"""
File: classification_grounded_args.py
Author: liwei(liwei85@baidu.com)
Date: 2021-09-15 14:23
Desc: classification arguments
"""
...
model_g.add_arg("vl_config_path", str, "./roberta_config/roberta_config.json",
...
run_type_g.add_arg("base_mnli", bool, False, "must be set True when train STS-B/MRPC/RTE model")

run_type_g.add_arg("num_codebook", int, 2048, "size of image codebook")
run_type_g.add_arg("model_type", str, "grounded",
                   "type of base model", choices=['grounded', 'baseline'])
run_type_g.add_arg("grounding_method", str, "topk",
                   "type of grounding method", choices=['normal', 'topk', 'optimal'])
run_type_g.add_arg("topk_value", int, 100, "pamater for topk grounding")
run_type_g.add_arg("with_grounding_projection", bool, False, "Whether to use linear projection before cmcl")
model_g.add_arg("with_grounding_pos", bool, False, "Whether to use pos_emb for grounding tokens")
