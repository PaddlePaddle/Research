...
"""
File: vision_transformer_encoder.py
Author: liwei(liwei85@baidu.com)
Date: 2021-07-20 20:46
Desc: Vision Transformer encoder.
"""
...
def encoder(enc_input,
    ...
    enc_output = pre_process_layer(
        enc_output, preprocess_cmd, prepostprocess_dropout, name="vit.post_encoder", trainable=trainable)
