            ...
            for j, utterance in enumerate(session):
                ...
                if "topic_a_topic_a_" not in utterance_gener and \
                   ...
                   "topic_b_topic_b_" not in utterance_gener:
                    print("candidate_set_gener:", key, utterance_gener)
