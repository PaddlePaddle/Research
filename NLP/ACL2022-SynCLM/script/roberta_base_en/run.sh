...
python3 -u ./src/launch.py ${distributed_args} \
    ./src/pretrain.py --use_cuda "True" \
                ...
                --init_checkpoint "./model_files/roberta_base_en" \
                --init_step 0 \
                --roberta_vocab_file "./model_files/dict/roberta_base_en.vocab.txt" \
                --encoder_json_file "./model_files/dict/roberta_base_en.encoder.json" \
                --vocab_bpe_file "./model_files/dict/roberta_base_en.vocab.bpe" \
                --synclm_config_path "./model_files/config/roberta_base_en.json" \
                --learning_rate 3e-5 \
                --warmup_steps 24000 \
                --weight_decay 0.005 \
                --max_seq_len 512 \
