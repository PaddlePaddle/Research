...
from model import roberta_tokenization as tokenization
...
class RegressionReader(object):
    ...
    def __init__(self, tokenizer, args):
        ...
        self.single_modal_id = tokenizer.single_modal_id

        self.max_seq_len = args.max_seq_len
        self.in_tokens = args.in_tokens
        self.use_modal_tag = args.use_modal_tag
    ...
    def _pad_batch_records(self, batch_records):
        ...
        padded_text_type_ids = pad_batch_data(batch_text_type_ids, pretraining_task='nlu', pad_idx=self.pad_id)
        padded_position_ids = pad_batch_data(batch_position_ids, pretraining_task='nlu', pad_idx=self.pad_id)

        return_list = [
            padded_token_ids, padded_text_type_ids, padded_position_ids, input_mask, batch_labels, batch_qids
        ]
    ...
    def _convert_example_to_record(self, example, max_seq_length, tokenizer):
        ...
        if self.use_modal_tag:
            token_ids = [self.single_modal_id] + token_ids
            position_ids = [0] + position_ids
            text_type_ids = [0] + text_type_ids
    ...
    def data_generator(self, input_file, batch_size, epoch, dev_count=1, shuffle=True, phase=None):
        ...
        def wrapper():
            ...
            for epoch_index in range(epoch):
                ...
                for batch_data in self._prepare_batch_data(current_examples, batch_size, phase=phase):
