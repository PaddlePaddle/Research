...
"""
# @Author : Gao Can
# @Created Time : 2020-07-17 10:14:13
# @Description : 
"""
...
model_g.add_arg("random_slot", int, -4, "random slot in log file")
...
def print_stat(score_files):
    ...
    log = 'tot_random_seed %d\nmax_score %f max_file %s\nmin_score %f min_file %s\nmedian_score %f median_file %s\navg_score %f' % \
          (nums, max_score, max_score_file, min_score, min_score_file, median_score, median_score_file, mean_score)
    print(log)
