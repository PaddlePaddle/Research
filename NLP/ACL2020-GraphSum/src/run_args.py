...
graphsum_g.add_arg("max_para_len", int, 60, "Number of words in longest paragraph.")
graphsum_g.add_arg("max_para_num", int, 30, "Number of paragraphs of the longest documents.")
