...
from model.SSAN_encoder import encoder, pre_process_layer
...
class ErnieModel(object):
    def __init__(self,
        ...
        self._ent_ner_types = 7
        self._ent_pos_types = 42 + 1
        ...
        self._ent_ner_emb_name = "ent_ner_embedding"
        self._ent_pos_emb_name = "ent_pos_embedding"
        ...
        self._with_ent_structure = with_ent_structure
        ...
        self._build_model(src_ids, position_ids, sentence_ids, task_ids,
                          input_mask, ent_ner, ent_pos, structure_mask)
    ...
    def _build_model(self, src_ids, position_ids, sentence_ids, task_ids,
        ...
        ent_ner_emb_out = fluid.layers.embedding(
            ent_ner,
            size=[self._ent_ner_types, self._emb_size],
            dtype=self._emb_dtype,
            param_attr=fluid.ParamAttr(
                name=self._ent_ner_emb_name, initializer=self._param_initializer))

        ent_pos_emb_out = fluid.layers.embedding(
            ent_pos,
            size=[self._ent_pos_types, self._emb_size],
            dtype=self._emb_dtype,
            param_attr=fluid.ParamAttr(
                name=self._ent_pos_emb_name, initializer=self._param_initializer))

        emb_out = emb_out + position_emb_out
        emb_out = emb_out + sent_emb_out
        emb_out = emb_out + ent_ner_emb_out
        emb_out = emb_out + ent_pos_emb_out
        ...
        self._enc_out = encoder(
            ...
            with_ent_structure=self._with_ent_structure,
