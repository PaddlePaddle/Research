...
# 训练集数量
cfg.DATASET.TRAIN_TOTAL_IMAGES = 2975 #5 
# 验证集列表
...
cfg.TRAIN.MODEL_SAVE_LAST = ''
cfg.TRAIN.MODEL_SAVE_BEST = ''
# 预训练模型路径
cfg.TRAIN.PRETRAINED_MODEL_FILE = ''
# 是否resume，继续训练
...
cfg.TEST.MULTI_SCALE = True
cfg.TEST.FLIP = True
cfg.TEST.OUTPUT_PATH = "output"
cfg.TEST.TEST_MODEL_FILE = ''
