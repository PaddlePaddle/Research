...
__all__ = [
    "ResNeXt_MultiBranch", "ResNeXt101_vd_64x4d","ResNeXt101_vd_32x4d",
]


class ResNeXt_MultiBranch():
...
def ResNeXt101_vd_64x4d_MB():
    model = ResNeXt_MultiBranch(layers=101, is_3x3=True)
    return model


def ResNeXt101_vd_32x4d_MB():
    model = ResNeXt_MultiBranch(layers=101, cardinality=32, is_3x3=True)
    return model
