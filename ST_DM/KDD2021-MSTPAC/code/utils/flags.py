...
def _define_helper(flag_name, default_value, docstring, flagtype, **kwargs):
...
def DEFINE_custom(flag_name, default_value, docstring, **args):
    """Defines a flag with custom type and specific action
    ...
    """
    _define_helper(flag_name, default_value, docstring, str, **args)


def get_flags_dict():
    """Get initialized FLAGS's inner dict"""

    if not FLAGS.__dict__['__parsed']:
        FLAGS._parse_flags()
    return FLAGS.__dict__['__flags']
