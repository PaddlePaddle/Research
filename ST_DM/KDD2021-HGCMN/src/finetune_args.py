...
data_g.add_arg("max_seq_len", int, 80, "Number of words of the longest seqence.")
...
run_type_g.add_arg("graph_data", type=str, default=[], nargs='+', help="grpah")
run_type_g.add_arg("sage_mode", str, "base", "gcn / erniesage / base")
run_type_g.add_arg("data_path", str, None, "data path")
run_type_g.add_arg("eval_path", str, None, "eval path")
run_type_g.add_arg("dump_task", str, None, "dump model task poi/query")
run_type_g.add_arg("norm_output", bool, False, "normalize output")
run_type_g.add_arg("model_type", str, "ernie", "ernie / cnn / ernie_xlmr ")
run_type_g.add_arg("token_mode", str, "ernie", "tokenization mode")
run_type_g.add_arg("norm_score", bool, False, "norm_score")
run_type_g.add_arg("temperature", float, 1, "temperature")
run_type_g.add_arg("scale_softmax", bool, False, "scale softmax")
run_type_g.add_arg("with_city", bool, False, "with_city")
run_type_g.add_arg("with_geo_id", bool, False, "with_geo_id")
