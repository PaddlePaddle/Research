...
class ImgGeoDataset(Dataset):
    ...
    def _load_anno(self):
        ...
        with open(self.cls_label_path) as fd:
            ...
            for l in lines:
                ...
                self.coordinates.append(np.array([float(l[3]), float(l[4])]))
    ...
    def __getitem__(self, idx):
        ...
        """
        ret = {}
        # img = cv2.imread(os.path.join(self.image_root, self.images[idx]))
...
if __name__ == '__main__':
    ...
    cls_label_path = '/home/yuwei/code/paddle/MultiModelFuse-paddle/data/imggeo/train.imggeo.new'
    ...
    dataset = ImgGeoDataset(image_root, cls_label_path, transform)
